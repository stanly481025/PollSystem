...
<html>
   ...
   <body>
			...
			if(displayPoll!=null){
				...
				for(Polls a : displayPoll)
				{
					out.print("<div class = 'contentDiv' style = 'top : " + i + "px;'>"
							...
							+ "<a href = ShowPollServlet?id=" + a.getID() + "><button type='button' class = 'contentDB'>進入問卷</button></a>"
							+ "</div>");
				}
			}
		%>
	...
	<div id = "browsD">
		...
		<div id = "browsDD">
		<%
			ArrayList<String> browseRecord = (ArrayList<String>)request.getAttribute("browseRecord");
