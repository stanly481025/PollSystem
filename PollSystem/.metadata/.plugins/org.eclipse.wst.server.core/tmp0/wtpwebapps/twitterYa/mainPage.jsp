      ...
      <script>
		 ...
		 function setWord()
		 {
			...
			document.getElementById( "undersearch" ).innerHTML = "推薦關鍵字 :"
															   + "&nbsp<a href = '" + link + "search?q=世足" + "' target = 'blink' style = 'text-decoration: none;'><red>世足</red>."
															   + "&nbsp<a href = '" + link + "search?q=俄羅斯" + "' target = 'blink' style = 'text-decoration: none;'><red>俄羅斯</red>."
															   + "&nbsp<a href = '" + link + "search?q=旅遊" + "' target = 'blink' style = 'text-decoration: none;'><red>旅遊</red>."
															   + "&nbsp<a href = '" + link + "search?q=NBA" + "' target = 'blink' style = 'text-decoration: none;'><red>NBA</red>";
		 }
